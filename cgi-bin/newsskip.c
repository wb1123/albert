...
int main(){
    ...
    printf("<style>"
            ".title{list-style:none;margin:10px;font-size:40px;color:red;}"\
            "</style>"
                    );
    // printf("<div style='width:600px;height:500px;color:black;background-color:yellow;text-align:center;font-size:30px;'></div>");
